...
public class FakeReceiverFactory implements DoubleParamFactory<Receiver, Storage, FakeReceiverMessageChooser> {
    @Override
    public Receiver create(Storage storage, FakeReceiverMessageChooser messageChooser) throws CreationException {
        ...
        var multyThreadedProcessor = processor;//new MultyThreadedProcessor(processor);
        ...
        return receiver;//MultyThreadedFakeReceiver(receiver);
    }
}
